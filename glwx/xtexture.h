...
#ifndef OPENGL_WRAP_X_XTEXTURE_H
#define OPENGL_WRAP_X_XTEXTURE_H
...
public:
    ...
    xtexture(std::string name, const char* path)
    {
        this->name = name;
        glGenTextures(1, &ID);
    ...
    void bind_texture(xshader* shader, GLenum loc)
    {
...
#endif //OPENGL_WRAP_X_XTEXTURE_H
